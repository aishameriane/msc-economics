...
* Exchange rate, R\$/US\$, <span style="color:red">(comercial, compra, média do período). Obs: inflação já descontada.</span>
...
## Raw series
  ...
  pdf(file="C:\\Users\\Aishameriane\\OneDrive\\Documentos\\Mestrado Economia\\Bayesiana - 2017-01\\Materiais artigo\\Estudo\\Seminario\\Seminário 02\\graphs\\ibcbr_01.pdf")
q + 
    theme(axis.text.x = element_text(angle = 90, hjust = 1))
dev.off()
...
## Annual variation
  ...
  pdf(file="C:\\Users\\Aishameriane\\OneDrive\\Documentos\\Mestrado Economia\\Bayesiana - 2017-01\\Materiais artigo\\Estudo\\Seminario\\Seminário 02\\graphs\\ibcbr_02.pdf")
q + 
    theme(axis.text.x = element_text(angle = 90, hjust = 1))
dev.off()
...
## Raw series
  ...
  pdf(file="C:\\Users\\Aishameriane\\OneDrive\\Documentos\\Mestrado Economia\\Bayesiana - 2017-01\\Materiais artigo\\Estudo\\Seminario\\Seminário 02\\graphs\\ipca_01.pdf")
q + 
    theme(axis.text.x = element_text(angle = 90, hjust = 1))
dev.off()
...
## Annual variation
  ...
  pdf(file="C:\\Users\\Aishameriane\\OneDrive\\Documentos\\Mestrado Economia\\Bayesiana - 2017-01\\Materiais artigo\\Estudo\\Seminario\\Seminário 02\\graphs\\ipca_02.pdf")
q + 
    theme(axis.text.x = element_text(angle = 90, hjust = 1))
dev.off()
...
## Raw series
  ...
  pdf(file="C:\\Users\\Aishameriane\\OneDrive\\Documentos\\Mestrado Economia\\Bayesiana - 2017-01\\Materiais artigo\\Estudo\\Seminario\\Seminário 02\\graphs\\selic_01.pdf")
q + 
    theme(axis.text.x = element_text(angle = 90, hjust = 1))
dev.off()
...
## Annual variation
  ...
  pdf(file="C:\\Users\\Aishameriane\\OneDrive\\Documentos\\Mestrado Economia\\Bayesiana - 2017-01\\Materiais artigo\\Estudo\\Seminario\\Seminário 02\\graphs\\selic_02.pdf")
q + 
    theme(axis.text.x = element_text(angle = 90, hjust = 1))
dev.off()
...
## Raw series
  ...
  pdf(file="C:\\Users\\Aishameriane\\OneDrive\\Documentos\\Mestrado Economia\\Bayesiana - 2017-01\\Materiais artigo\\Estudo\\Seminario\\Seminário 02\\graphs\\exrate_01.pdf")
q + 
    theme(axis.text.x = element_text(angle = 90, hjust = 1))
dev.off()
...
## Annual variation
  ...
  pdf(file="C:\\Users\\Aishameriane\\OneDrive\\Documentos\\Mestrado Economia\\Bayesiana - 2017-01\\Materiais artigo\\Estudo\\Seminario\\Seminário 02\\graphs\\exrate_02.pdf")
q + 
    theme(axis.text.x = element_text(angle = 90, hjust = 1))
dev.off()
