...
## Saving everything in a new document
  ...
  dados_artigo <- data.frame(dados_list[[1]][13:172,1], dados_list[[1]][13:172,2], dados_list_an[[1]][,2], dados_list[[2]][13:172,2], dados_list_an[[2]][,2], dados_list[[3]][13:172,2], dados_list_an[[3]][,2], dados_list[[4]][13:172,2], dados_list_an[[4]][,2])
  
  head(dados_artigo)
  colnames(dados_artigo) <- c("Data", "IBCraw", "IBCvar", "IPCAraw", "IPCAvar", "SELICraw", "SELICvar", "EXRTraw", "EXRTvar")
  write.csv(dados_artigo, file = "C:\\Users\\Aishameriane\\OneDrive\\Documentos\\Mestrado Economia\\Bayesiana - 2017-01\\Materiais artigo\\Dados\\dados_final.csv", row.names = FALSE)
...
dados_artigo <- read.csv("C:\\Users\\Aishameriane\\OneDrive\\Documentos\\Mestrado Economia\\Bayesiana - 2017-01\\Materiais artigo\\Dados\\dados_final.csv", sep = ",", header = TRUE, dec = ".")
...
colnames(df) <- c("Variable", "Dickey Fuller", "Lar Order", "p-value", "")
