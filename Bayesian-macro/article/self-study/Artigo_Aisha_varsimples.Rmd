...
\begin{equation}
Y_t = X_(t)_t \times A + \varepsilon_t
\end{equation}
...
if (prior == 1) { # noninformative prior
 # Nothing happens, the posterior will depend on OLS quantities
  ...
  ## So proud I could figure it out after some time thinking, some lasanha, screams and frustration
...
Pred_mean <- X_tplus1 %*% as.matrix(A_post)
```
