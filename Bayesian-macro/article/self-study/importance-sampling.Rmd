...
Var(\hat{p}_3) = 0 - Var\left(\frac{1}{m} \sum\limits_{j=1}^m h(U_j) = \frac{1}{2} - \frac{1}{m} \sum\limits_{j=1}^m \frac{2}{\pi}(1+U_j^2)\right) = \frac{1}{m^2} \sum\limits_{j=1}^m Var(h(U_j)) = \frac{1}{m^2} \cdot m Var(h(U_j)) = \frac{1}{m} Var(h(U_j))
\end{equation}
