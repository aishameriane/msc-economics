...
Yraw <- dados[,columns]
head(Yraw)
Yraw <- data.frame(matrix(t(Yraw), nrow = 4))
```
...
# Since Koop's code does not have time trend, I'll mantain it
constant = 1
...
for (rep in repstart:repetitions){
  ...
  draws <- c(draws, list(list(bmat, hmat, wlogmat, wlogmax, wmat, ptlogmat, pclogmat))) # Aisha: Little different from Uhlig's approach, it's simpler to deal in R
...
numberofpaths <- 1 # Aisha: Dunno what's this for
