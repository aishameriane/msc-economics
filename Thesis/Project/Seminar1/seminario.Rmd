...
* Lucas' Critique (1976) is about the inadequacy to assume stability of the model's structure:
    * If the parameters are fixed, then the model shouldn't be used as "laboratory" to simulate alternative policies.
...
makeBG(id='ThisSlide', 'images\\Imagem4.png')
```
...
- But even with the simplification, estimaion is still a challenge...
