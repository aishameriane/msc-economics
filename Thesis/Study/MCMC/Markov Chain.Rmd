...
2. **Na página 86 do [@greenberg2008] tem o seguinte: $P_X(X_n \ \in \ B i.o.) = 1, \ \text{for} \ \pi\text{-almost all}\ x$. Eu não entendi o que isso quer dizer... A definição do _i.o._ está na página 83, onde ele diz que significa _infinetely often_**. 

Resposta: para entender isso, precisamos da definição abaixo:
