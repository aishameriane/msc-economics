---
title: "Teoria Macroeconômica II - Artigo"
...
matplot2(x = xax, y = x1, ylim = c(0.04, 0.065), col = cols1, main = "Razão Capital/Trabalho", xlab = "Tempo")
```
...
matplot2(x = xax, y = x2, ylim = c(0.45, 0.65), col = cols1, main = "Selic", xlab = "Tempo")
```
...
matplot2(x = xax, y = x3, col = cols1, main = "IBC-Br", xlab = "Tempo")
```

```{r, eval = FALSE}
# Gráfico do desvio padrão do resíduo do cambio
sd_cambio <- parameter.draws(fit1, type = "vcv", row = 3, col = 3)
x4 <- t(apply(sqrt(sd_cambio), 2, stat.helper))
matplot2(x = xax, y = x4, col = cols1, main = "Cambio", xlab = "Tempo")
```

```{r, eval = FALSE}
# Gráfico do desvio padrão do resíduo do ipca
sd_ipca <- parameter.draws(fit1, type = "vcv", row = 3, col = 3)
x5 <- t(apply(sqrt(sd_ipca), 2, stat.helper))
matplot2(x = xax, y = x5, col = cols1, main = "IPCA", xlab = "Tempo")
```
