...
5. Crescimento da taxa de câmbio (para _growth of the nominal effective exchange rate_). Usei a série:
    * `Taxa de câmbio - Livre - Dólar americano (venda) - Fim de período - mensal (3696)`. Como o Muntaz disse que usou log diferença, eu calculei o log e tirei primeira diferença nessa série.
