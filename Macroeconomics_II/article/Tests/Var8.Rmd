---
title: "Teoria Macroeconômica II - Artigo parte II - Oitavo Var"
...
Este documento contém a oitava especificação do VAR que eu testei. Ela é a mesma variação do VAR 4, porém com diagnóstico de convergência e com o ajuste de sazonalidade feito corretamente nas variáveis. A parte de previsão ainda não está implementada completamente e preciso ver como a ordem das variáveis afeta nas funções impulso resposta (testarei no Var9).
...
pacman::p_load(ggplot2, forecast, BETS, seasonal, seasonalview, bvarsv, lubridate, zoo, stargazer, gridExtra, reshape2, ggfortify, RColorBrewer, scales, quantmod, PerformanceAnalytics, strucchange, coda, knitr, grid, ggpubr, gdata) 
```
...
#fit1 <- readRDS("C:\\Users\\aisha\\Documents\\Var da Aisha\\Var7\\fit8.rds")
#rm(fit1, ira)
proc.time() - pm
```
...
saveRDS(fit1, "C:\\Users\\aisha\\Documents\\Var da Aisha\\Var7\\fit8.rds")
