---
title: "Teoria Macroeconômica II - Artigo parte II - Quinto Var"
...
Este documento contém a quinta especificação do VAR que eu testei.
...
# Especificação 5: 5 variáveis, 2000-2017

## Tentativa 1

A quinta tentativa foi com dados de **janeiro de 2000** a **outubro de 2017** incluiu as seguintes variáveis:
...
4. PIB mensal, utilizando a seguinte série:
...
# There is a strange problem with the GDP: if we start in 2000, the X-13 returns an error
inicio <- "1999-01-01"
fim    <- "2017-11-30"
...
# Usando ndiffs(PIBmensal_raw,test="adf",alpha = 0.1) se encontra que o ibcbr é não estacionário.
...
# Eixo x
xax <- time(var1)
# Perde duas observação pelo lag e outras 48 pela amostra para estimar por MQO, então começa no tempo 50
xax <- xax[51:227]
...
![Volatilidade capital-trabalho](C:\\Users\\Aishameriane\\OneDrive\\Documentos\\Mestrado Economia\\Teoria Macroeconômica II - 2017-2\\Artigo\\Aplicação\\Var5\\01.png)
...
![Volatilidade selic](C:\\Users\\Aishameriane\\OneDrive\\Documentos\\Mestrado Economia\\Teoria Macroeconômica II - 2017-2\\Artigo\\Aplicação\\Var5\\02.png)
...
![Volatilidade PIB](C:\\Users\\Aishameriane\\OneDrive\\Documentos\\Mestrado Economia\\Teoria Macroeconômica II - 2017-2\\Artigo\\Aplicação\\Var5\\03.png)
...
![Volatilidade Câmbio](C:\\Users\\Aishameriane\\OneDrive\\Documentos\\Mestrado Economia\\Teoria Macroeconômica II - 2017-2\\Artigo\\Aplicação\\Var5\\04.png)
...
![Volatilidade IPCA](C:\\Users\\Aishameriane\\OneDrive\\Documentos\\Mestrado Economia\\Teoria Macroeconômica II - 2017-2\\Artigo\\Aplicação\\Var5\\05.png)
...
![FIR da Selic na razão capital-trabalho](C:\\Users\\Aishameriane\\OneDrive\\Documentos\\Mestrado Economia\\Teoria Macroeconômica II - 2017-2\\Artigo\\Aplicação\\Var5\\01-fir_selic_ct.png)
...
![FIR da Selic no PIB](C:\\Users\\Aishameriane\\OneDrive\\Documentos\\Mestrado Economia\\Teoria Macroeconômica II - 2017-2\\Artigo\\Aplicação\\Var5\\02-fir_selic_pib.png)

```{r, eval = FALSE}
# Função Impulso resposta da selic no cambio
ira <- impulse.responses(fit1, impulse.variable = 2, response.variable = 4)
```

![FIR da Selic no câmbio](C:\\Users\\Aishameriane\\OneDrive\\Documentos\\Mestrado Economia\\Teoria Macroeconômica II - 2017-2\\Artigo\\Aplicação\\Var5\\03-fir_selic_cambio.png)

```{r, eval = FALSE}
# Função Impulso resposta da selic no ipca
ira <- impulse.responses(fit1, impulse.variable = 2, response.variable = 5)
```

![FIR da Selic no IPCA](C:\\Users\\Aishameriane\\OneDrive\\Documentos\\Mestrado Economia\\Teoria Macroeconômica II - 2017-2\\Artigo\\Aplicação\\Var5\\04-fir_selic_ipca.png)
...
![FIR do PIB na razão capital-trabalho](C:\\Users\\Aishameriane\\OneDrive\\Documentos\\Mestrado Economia\\Teoria Macroeconômica II - 2017-2\\Artigo\\Aplicação\\Var5\\05-fir_pib_ct.png)
...
![FIR do câmbio na razão capital-trabalho](C:\\Users\\Aishameriane\\OneDrive\\Documentos\\Mestrado Economia\\Teoria Macroeconômica II - 2017-2\\Artigo\\Aplicação\\Var5\\06-fir_cambio_ct.png)
...
![FIR do IPCA na razão capital-trabalho](C:\\Users\\Aishameriane\\OneDrive\\Documentos\\Mestrado Economia\\Teoria Macroeconômica II - 2017-2\\Artigo\\Aplicação\\Var5\\07-fir_ipca_ct.png)