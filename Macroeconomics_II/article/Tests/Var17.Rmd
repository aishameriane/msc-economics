---
title: "Teoria Macroeconômica II - Artigo parte II - Décimo Sétimo Var"
...
Este documento contém a décima sétima especificação do VAR que eu testei. Ela é igual do var14. A única coisa de diferente que fiz foi mudar a priori para colocar algo mais não informativo nos coeficientes.

Também tentei fazer o gráfico da estatística do Brooks Gelman e esse é meu VAR final, por isso os gráficos estão melhores. **Para a Aisha do futuro:** Tem que colocar os códigos dos gráficos das descritivas aqui.
...
fit1 <- readRDS("C:\\Users\\aisha\\Documents\\Var da Aisha\\Var7\\fit17.rds")
#rm(fit1, ira)
proc.time() - pm
...
saveRDS(fit1, "C:\\Users\\aisha\\Documents\\Var da Aisha\\Var7\\fit17.rds")
#fit1 <- readRDS("C:\\Users\\aisha\\Documents\\Var da Aisha\\Var7\\fit17.rds")
rm(fit1)
...
fit1 <- readRDS("C:\\Users\\aisha\\Documents\\Var da Aisha\\Var7\\fit17a.rds")
proc.time() - pm
#saveRDS(fit1, "C:\\Users\\aisha\\Documents\\Var da Aisha\\Var7\\fit17a.rds")
...
set.seed(9696)
fit1 <- readRDS("C:\\Users\\aisha\\Documents\\Var da Aisha\\Var7\\fit17b.rds")
#fit1 <- bvar.sv.tvp(var1, p=p., tau = tau., nburn = nburn., nrep = nrep., nf = nf., thinfac = thinfac.)
#saveRDS(fit1, "C:\\Users\\aisha\\Documents\\Var da Aisha\\Var7\\fit17b.rds")
