---
title: "Teoria Macroeconômica II - Artigo parte II - Décimo Quinto Var"
...
Este documento contém a décima quinta especificação do VAR que eu testei. Ela é similar a do VAR 14, porém com uma defasagem a mais.
...
fit1 <- readRDS("C:\\Users\\aisha\\Documents\\Var da Aisha\\Var7\\fit15.rds")
#rm(fit1, ira)
proc.time() - pm
...
#saveRDS(fit1, "C:\\Users\\aisha\\Documents\\Var da Aisha\\Var7\\fit15.rds")
#fit1 <- readRDS("C:\\Users\\aisha\\Documents\\Var da Aisha\\Var7\\fit15.rds")
rm(fit1)
...
matplot2(x = xax, y = x2, ylim = c(sqrt(min(desc_sd$quantiles[,1])), sqrt(max(desc_sdswap$quantiles[,5]))), col = cols1, main = "Volatilidade dao Swap", xlab = "Tempo")
par(old.par) # resets par()
...
#fit1 <- readRDS("C:\\Users\\aisha\\Documents\\Var da Aisha\\Var7\\fit145a.rds")
proc.time() - pm
saveRDS(fit1, "C:\\Users\\aisha\\Documents\\Var da Aisha\\Var7\\fit15a.rds")
#rm(fit1)
...
set.seed(9696)
#fit1 <- readRDS("C:\\Users\\aisha\\Documents\\Var da Aisha\\Var7\\fit15b.rds")
fit1 <- bvar.sv.tvp(var1, p=p., tau = tau., nburn = nburn., nrep = nrep., nf = nf., thinfac = thinfac.)
saveRDS(fit1, "C:\\Users\\aisha\\Documents\\Var da Aisha\\Var7\\fit15b.rds")
