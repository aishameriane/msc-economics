---
title: "Teoria Macroeconômica II - Artigo parte II - Décimo Nono Var"
...
Este documento contém a décima nona especificação do VAR que eu testei. Ela é igual do VAR 17, porém dividi o IPCA e o Swap por 100.
...
var1 <- cbind(capital_trabalho_final, ipca/100, PIB2, swap/100, cambio) # The bvar function does not allows data.frames
...
#fit1 <- readRDS("C:\\Users\\aisha\\Documents\\Var da Aisha\\Var7\\fit19a.rds")
proc.time() - pm
saveRDS(fit1, "C:\\Users\\aisha\\Documents\\Var da Aisha\\Var7\\fit19a.rds")
...
set.seed(9696)
#fit1 <- readRDS("C:\\Users\\aisha\\Documents\\Var da Aisha\\Var7\\fit19b.rds")
fit1 <- bvar.sv.tvp(var1, p=p., tau = tau., nburn = nburn., nrep = nrep., nf = nf., thinfac = thinfac.)
saveRDS(fit1, "C:\\Users\\aisha\\Documents\\Var da Aisha\\Var7\\fit19b.rds")
